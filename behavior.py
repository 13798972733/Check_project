...
class ACNN(object):
    def __init__(self):
        ...
        self.batch_size = 20                 # 每次取n张图片                    # 模型输入图片大小
        self.model_save = "/coda/cws_AI/check/classes/object/modelsmaster/research/my_object_detection/models"
                  # 模型保存路径包括文件名
        self.data1 = []
        self.data = []                                      # 图像矩阵和标签
        ...
        self.CLASS_RESOURSE_PATH = "/coda/cws_AI/check/classes/object/modelsmaster/research/my_object_detection/images/3/1"
        self.CLASS_RESOURSE_PATH_ = "/coda/cws_AI/check/classes/object/modelsmaster/research/my_object_detection/images/3/2"
